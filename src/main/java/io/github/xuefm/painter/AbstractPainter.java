...
public abstract class AbstractPainter implements IPainter {
     ...
     */
    public final void draw(Graphics2D g2d, Element element, AbstractImageCombiner.CanvasProperty canvasProperty) throws ImageBuildException {
     ...
     */
    abstract void drawBefore(Graphics2D g2d, Element element, AbstractImageCombiner.CanvasProperty canvasProperty);
     ...
     * @param canvasProperty 画布属性
     */
    abstract void doDraw(Graphics2D g2d, Element element, AbstractImageCombiner.CanvasProperty canvasProperty);
     ...
     * @param canvasProperty 画布属性
     */
    abstract void drawAfter(Graphics2D g2d, Element element, AbstractImageCombiner.CanvasProperty canvasProperty);
}
